...
print("-----Pergunta 3-----")
print(f"Atletas na faixa etária 1 [30-34]: {intervalo1}\n")
print(f"Atletas na faixa etária 2 [35-39]: {intervalo2}\n")
print(f"Atletas na faixa etária 3 [40-44]: {intervalo3}\n")